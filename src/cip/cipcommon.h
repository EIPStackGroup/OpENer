 ...
 * @param pa_stInstance pointer to instance.
 * @param pa_stMRRequest pointer to request.
 * @param pa_MRResponse pointer to response.
 * @param pa_msg pointer to memory where response should be written
