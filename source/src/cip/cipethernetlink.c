 ...
 *      - Attribute  4: Interface Counters (32-bit) (0 !=
 * OPENER_ETHLINK_CNTRS_ENABLE)
 *      - Attribute  5: Media Counters (32-bit)     (0 !=
 * OPENER_ETHLINK_CNTRS_ENABLE)
 *      - Attribute  6: Interface Control           (0 !=
 * OPENER_ETHLINK_IFACE_CTRL_ENABLE)
 ...
 *  		This service should only be implemented if attribute 6 is
 * enabled.
 *
 */
...
EipStatus GetAndClearEthernetLink(
  ...
  if ((NULL != attribute) && (NULL != attribute->data)) {
    ...
    switch (attribute_number) {
      case 4: /* fall through */
      case 5:
        GetAttributeSingleEthernetLink(instance,
