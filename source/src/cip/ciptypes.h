...
typedef enum {
  ...
  kNvDataFunc = 0x80,  ///< enable Non Volatile data callback, is the same as
                       ///< @ref kPostSetFunc
} CIPAttributeFlag;
 ...
 *
 *  All instances are stored in a linked list that originates from the
 * CipClass::instances pointer of the @ref CipClass structure.
 */
 ...
 *  @param message_router_response storage for the response data, including a
