...
/** Indicates a pending configuration change in the TTL Value and/or Mcast
 * Config attributes.*/
static const CipDword kTcpipStatusMcastPend = 0x10U;
/** Indicates a pending configuration change in the Interface Configuration
 * attribute. */
...
/** Indicates when an IP address conflict has been detected by ACD or the
 * defense failed. */
