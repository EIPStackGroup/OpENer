...
/** @brief check if for the given connection data received in a forward_open
 * request a suitable connection is available.
 *
 ...
 *  @param extended_error pointer to the extended_error variable, if an error
 * occurred this value has the according error code for the response
 *  @return
 *        - on success: A pointer to the connection object already containing
