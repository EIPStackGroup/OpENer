 ...
 *
 *  Enum constants for the different network segment subtypes to decouple code
...
/** @brief Only to be used on Port Segments. Returns if the Port Segment has the
 * extended link address size bit set
 *
 * @param cip_path The start of the EPath message
 ...
 *
 * @param extended_port_identifier The extended port identifier to be encoded
 * into the message
 ...
 *
 * @param cip_path The start of the EPath message
 * @return The Special Type Logical Format subtype of a Logical Segment EPath
 * message
 */
LogicalSegmentSpecialTypeLogicalFormat
