 ...
 *
 * @param common_packet_format_data_item Common Packet Format item which is used
 * in the encoding
 * @param outgoing_message The outgoing message object
 */
 ...
 *
 * @param message_router_response The Router Response message which shall be
 * answered
 * @param outgoing_message The outgoing message object
 */
 ...
 *
 * @param message_router_response The router response message data structure to
 * be processed
 * @param outgoing_message The outgoing message object
 */
 ...
 *
 * This function uses EncodeExtendedStatusLength and
 * EncodeExtendedStatusDataItems to encode the complete extended status
