 ...
 *
 * @param received_data pointer to the encapsulation structure with the received
 * message
 ...
 * over in encapsulation.
 * @param  common_packet_format_data_item pointer to CPF structure which has to
 * be aligned into linear memory.
 ...
 * common_packet_format_data_item into ENIPMessage struct outgoing_message via
 * encapsulation.
 *
 * @param  message_router_response	pointer to message router response which
 * has to be aligned into linear memory.
 * @param  common_packet_format_data_item	pointer to CPF structure which
 * has to be aligned into linear memory.
 ...
 * For future extensions towards multithreading maybe more CPF data items may be
 * necessary
 */
