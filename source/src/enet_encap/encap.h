 ...
 * The Ethernet encapsulation layer handles provides the abstraction between the
 * Ethernet and the CIP layer.
 */
 ...
 *
 * Certain encapsulation message requests require a delayed sending of the
 * response message. This functions checks if messages need to be sent and
