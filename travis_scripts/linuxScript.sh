...
sonar-scanner -Dproject.settings=$TRAVIS_BUILD_DIR/sonar-project.properties -Dsonar.sources=. -Dsonar.exclusions=OpENer_coverage/**,dependencies/**,CMakeFiles/** -Dsonar.cfamily.gcov.reportsPath=./gcov_results -Dsonar.coverage.exclusions=$TRAVIS_BUILD_DIR/source/tests/*,$TRAVIS_BUILD_DIR/source/src/ports/*/sample_application/*,$TRAVIS_BUILD_DIR/source/tests/**/* -Dsonar.test.exclusions=$TRAVIS_BUILD_DIR/source/tests/**/*
